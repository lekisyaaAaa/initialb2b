    ...
    <div className="min-h-screen bg-gradient-to-br from-coffee-50 to-coffee-100">
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          <Link 
            to="/" 
            className="inline-flex items-center text-coffee-600 hover:text-coffee-800 transition-colors mb-4"
          >
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold text-coffee-900 mb-4">Contact Information</h1>
            ...
            >
              <div className="bg-gradient-to-r from-coffee-600 to-coffee-700 text-white p-6">
                <div className="flex items-center mb-3">
                  <div className="w-12 h-12 bg-coffee-500 rounded-full flex items-center justify-center mr-4">
              ...
              <div className="p-6 space-y-4">
                <div className="flex items-start">
                  <Building className="w-5 h-5 text-coffee-600 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm text-coffee-500 font-medium">Department</p>
                    <p className="text-coffee-800">{contact.department}</p>
                  </div>
                </div>

                <div className="flex items-start">
                  <Phone className="w-5 h-5 text-coffee-600 mr-3 mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start">
                  <Mail className="w-5 h-5 text-coffee-600 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm text-coffee-500 font-medium">Email</p>
                    <a 
                      href={`mailto:${contact.email}`}
                      className="text-coffee-800 hover:text-coffee-600 transition-colors break-all"
                    >
                      {contact.email}
                    </a>
                  </div>
                ...
                <div className="flex items-start">
                  <MapPin className="w-5 h-5 text-coffee-600 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm text-coffee-500 font-medium">Address</p>
                    <p className="text-coffee-800">{contact.address}</p>
                  </div>
                </div>

                <div className="flex items-start">
                  <Clock className="w-5 h-5 text-coffee-600 mr-3 mt-1 flex-shrink-0" />
                  <div>
                    <p className="text-sm text-coffee-500 font-medium">Availability</p>
                    <p className="text-coffee-800">{contact.availability}</p>
                  </div>
                </div>
              </div>

              <div className="bg-coffee-50 px-6 py-4">
                <div className="flex space-x-3">
                  <a
                    href={`tel:${contact.phone}`}
                    className="flex-1 bg-coffee-600 text-white text-center py-2 px-4 rounded-lg hover:bg-coffee-700 transition-colors"
                  >
                    Call
                  </a>
                  <a
                    href={`mailto:${contact.email}`}
                    className="flex-1 bg-coffee-200 text-coffee-800 text-center py-2 px-4 rounded-lg hover:bg-coffee-300 transition-colors"
                  >
                    Email
                  </a>
                </div>
        ...
        <div className="mt-12 bg-white rounded-xl shadow-lg p-8">
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-coffee-900 mb-2">Environmental Monitoring Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-coffee-900 mb-2">24/7 Monitoring</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-coffee-900 mb-2">Expert Support</h3>
              <p className="text-coffee-600 text-sm">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-coffee-900 mb-2">Quick Response</h3>
              <p className="text-coffee-600 text-sm">
